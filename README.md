...
A low-level Zig email library (SMTP, IMAP, POP3) backed by **libcurl** for robust TLS and networking. This project is a **protocol and authentication layer**, not a rendering engine.
